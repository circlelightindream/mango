...
import com.treasuremountain.mango.admin.dao.SysUserRoleMapper;
...
import com.treasuremountain.mango.common.utils.DateTimesUtils;
import com.treasuremountain.mango.common.utils.PoiUtils;
...
public class SysUserServiceImpl implements SysUserService {
    ...
    private void findUserRoles(PageResult pageResult) {
        ...
        for (Object object : content) {
            ...
            sysUser.setRoleName(getRoleNames(userRoles));
        }
    }
    ...
    public static File createUserExcelFile(List<?> records) {
        ...
        for (int i = 0; i < records.size(); i++) {
            ...
            row.getCell(++columnIndex).setCellValue(DateTimesUtils.getDateTime(user.getCreateTime()));
            row.getCell(++columnIndex).setCellValue(user.getLastUpdateBy());
            row.getCell(++columnIndex).setCellValue(DateTimesUtils.getDateTime(user.getLastUpdateTime()));
        }
