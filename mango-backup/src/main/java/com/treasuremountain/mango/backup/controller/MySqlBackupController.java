package com.treasuremountain.mango.backup.controller;

import com.treasuremountain.mango.backup.config.BackupDataSourceProperties;
import com.treasuremountain.mango.backup.constants.BackupConstants;
import com.treasuremountain.mango.backup.service.MysqlBackupService;
import com.treasuremountain.mango.backup.util.HttpResult;
    ...
    public HttpResult findBackupRecords() {
        ...
        if (restoreFolderFile.exists()) {
            for (File file : restoreFolderFile.listFiles()) {
                Map<String, String> backup = new HashMap<>(16);
